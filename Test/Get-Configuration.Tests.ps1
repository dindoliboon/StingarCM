...
InModuleScope $script:ModuleName {
    Describe 'Get-Configuration' -Tags Build , Unit {
        Context 'When retrieving valid configuration data' {
            $Script:AppConfig = @{
            ...
            New-Configuration -ConfigurationName $configurationName | Out-Null
        ...
        Context 'When config file does not exist' {
            ...
            # Force testing when config file does not exist.
